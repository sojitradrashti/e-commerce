...
const Cart = () => {
  return (
    <>
      <div
        className={`fixed top-0 right-0 left-0 bottom-0 w-full h-screen bg-white/ bg-clip-padding backdrp-filter backdrop-blur bg-opacity-50 opacity-100 z-[250] shadow-sm shadow-slate-100 transition-all duration-300 `}>
        <div
